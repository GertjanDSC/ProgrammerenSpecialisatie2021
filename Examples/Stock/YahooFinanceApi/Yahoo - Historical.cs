...
namespace YahooFinanceApi
{
    ...
    {
        private static CsvHelper.Configuration.CsvConfiguration _configuration = new CsvHelper.Configuration.CsvConfiguration(CultureInfo.InvariantCulture);
            ...
            )
        {
            ...
            using (var csvReader = new CsvReader(sr, _configuration))
            {
